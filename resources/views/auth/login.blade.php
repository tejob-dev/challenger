        ...
        <div class="vc_column-inner vc_custom_1671743775252">
            <div class="wpb_wrapper">
                <div class="ult-content-box-container medium-padding-mobile">
                    ...
                    data-normal_margins="margin-top:0px;margin-right:28%;margin-bottom:0px;margin-left:28%;" data-bg="#ffffff">
                        
                    <h4 style="text-align: center;" class="vc_custom_heading">Connexion</h4>
                        ...
                        <div class="wpcf7 no-js" id="wpcf7-f827-o1" lang="en-US" dir="ltr">
                            ...
                            <form action="{{ route('login') }}"  method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                                <div class="nyssa-single-fields">
                                    @csrf
                                    <div class="f-email">
                                        <p>
                                    ...
                                    <div class="bt-contact">
                                        <p style="display: flex;justify-content: center;align-items: center;">
                                            <a class="btn-contact-left">
                                                <input class="wpcf7-form-control has-spinner wpcf7-submit" type="submit" value="Se connecter"/>
                                            </a>
                                        </p>
                                        <a href="/register" style="text-decoration: underline;">Je m'enregistre</a>
                                    </div>
                                </div>
