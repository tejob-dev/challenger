            ...
            <div id="nyssa-push-sidebar-content" class="nyssa-push-sidebar-content ajaxable">
                ...
                <div class="sidebar-box widget_text" id="text-2">
                    <div class="textwidget">
                        <p><span style="text-align: center;">Challenge-toit est une solution alternative pour l'achat d'une maison qui permet de verser des paiements échelonnés sur une période allant de 5 à 10 ans selon vos capacités financières plutôt que de payer le prix total au moment de la clôture de la vente.</span></p>
                    </div>
                </div>
                <div id="nyssa_socials_widget-2" class="widget nyssa_socials_widget">
                    ...
                    <div class="social-icons-fa align-center">
                        <ul>
                            <li><a href="#" target="_blank" class="social-network twitter" title="Twitter"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <li><a href="#" target="_blank" class="social-network twitch" title="Twitch"><i class="fab fa-twitch"></i></a></li>
                            <li><a href="#" target="_blank" class="social-network weixin" title="Weixin"><i class="fab fa-weixin"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="nav-container ">
                ...
                <div id="dl-menu" class="dl-menuwrapper">
                    ...
                    <ul id="menu-primary-navigation" class="dl-menu">
                        @if (Auth::user()!=null)
                            @if(Auth::user()->is_admin == true)
                                <li class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children page-4445"><a href="/acquereurs" class="menu-link main-menu-link">Acquereurs</a><span class="gosubmenu ion-chevron-right"></span>
                                </li>
                                <li class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children page-24 mobile-opened"><a href="/challengerpro" class="menu-link main-menu-link">Challenger Pro</a><span class="gosubmenu ion-chevron-right"></span>
                                </li>
                                <li class="main-menu-item  menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971"><a href="/parrains" class="menu-link main-menu-link">Parrainage</a><span class="gosubmenu ion-chevron-right"></span>
                                </li>
                                <li class="main-menu-item  menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971"><a href="/contacts" class="menu-link main-menu-link">Contacts</a><span class="gosubmenu ion-chevron-right"></span>
                                </li>
                                <li class="main-menu-item  menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971">
                                    
                                    <div style="display:inline-block;">  {{Auth::user()->name}}
                                        <div style="display:inline-block;">
                                            <a class="" href="#getdown" onclick="event.preventDefault(); document.getElementById('logout-form').submit(); return false;" style="text-decoration: underline;color: #c1baba;">
                                                {{ __('Se déconnecter') }}
                                            </a>
                    ...
                    <div class="menu_style5_bearer">
                        ...
                        @if (Auth::user()!=null)
                            @if(Auth::user()!=null & Auth::user()->is_admin == true)
                                <li class="main-menu-item menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971" style="pointer-events: auto;"><a href="/acquereurs" class="menu-link main-menu-link">Acquéreurs</a>
                                </li>
                                <li class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3972" style="pointer-events: auto;"><a href="/challengerpro" class="menu-link main-menu-link">Challenge Pro</a>
                                </li>
                                <li class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3965" style="pointer-events: auto;"><a href="/parrains" class="menu-link main-menu-link">Parrains</a>
                                </li>
                                <li class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3965" style="pointer-events: auto;"><a href="/contacts" class="menu-link main-menu-link">Contacts</a>
                                </li>
                            @endif
                        @endif
                        </ul>
                ...
                <div class="nyssa_right_header_icons with-woocommerce-cart">
                    ...
                    <div class="header_social_icons  disable_nyssa_social_icons_mobile">
                        ...
                        <div class="search_trigger disable_nyssa_search_mobile"></div>

                        <div class="menu-controls sliderbar-menu-controller disable_nyssa_sliding_panel_mobile">
                            @if (Auth::user()!=null)
                            @if(Auth::user()!=null & Auth::user()->is_admin == true)
                                <div style="color: white!important;display: flex;flex-direction: column;align-items: center;">
                                    <div style="display:inline-block;"><i class="fas fa-caret-down"></i>{{Auth::user()->name}}</div>
                                    <div>
                                        <a class="" href="#getdown" onclick="event.preventDefault(); document.getElementById('logout-form').submit(); return false;" style="text-decoration: underline;color: #c1baba;">
                                            {{ __('Se déconnecter') }}
                                        </a>
                    ...
                    <ul id="menu-primary-navigation" class="dl-menu">
                        @if (Auth::user()!=null)
                            ...
                            @if(Auth::user()->is_admin == true)
                                ...
                                <li class="main-menu-item  menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971"><a href="/parrains" class="menu-link main-menu-link">Parrains</a><span class="gosubmenu ion-chevron-right"></span>
                                </li>
                                <li class="main-menu-item  menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971"><a href="/contacts" class="menu-link main-menu-link">Contacts</a><span class="gosubmenu ion-chevron-right"></span>
                                </li>
                            @endif
                ...
                <div class="navbar-collapse collapse">
                    <div class="menu_style5_bearer">
                        <ul id="menu-primary-navigation-1" class="nav navbar-nav navbar-right">
                            @if (Auth::user()!=null)
                                @if(Auth::user()->is_admin == true)
                                    <li class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children page-4445" style="pointer-events: auto;"><a href="/acquereurs" class="menu-link main-menu-link">Acquereurs</a>
                                    </li>
                                    <li class="main-menu-item menu-item-even menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children page-24 mobile-opened" style="pointer-events: auto;"><a href="/challengerpro" class="menu-link main-menu-link">Challenger Pro</a>
                                    </li>
                                    <li class="main-menu-item menu-item-even menu-item-depth-0 nyssa_mega_menu menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3971" style="pointer-events: auto;"><a href="/parrain" class="menu-link main-menu-link">Parrainage</a>
                                    </li>
                                @endif
                            @endif
                        </ul>
