...
<html lang="en-US">
    <head>
        ...
        <script type="text/javascript">
            window._wpemojiSettings = {
                ...
                "svgExt": ".svg",
                "source": {
                    "concatemoji": "https:\/\/preview.treethemes.com\/nyssa\/demo1\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.1.1"
                }
            };
        ...
        <link rel='stylesheet' id='nyssa-selectwoo-css' href='https://preview.treethemes.com/nyssa/demo1/wp-content/themes/nyssa/css/selectWoo.min.css?ver=6.1.1' type='text/css' media='all'/>
        ...
        <style id='nyssa-style-inline-css' type='text/css'>
            ...
            .vc_toggle_square .vc_toggle_icon,p.vc_custom_heading.heading_border::before {
            ...
            body .ls-roundedflat .ls-nav-prev:hover, body .ls-roundedflat .ls-nav-next:hover,body .ls-roundedflat .ls-bottom-slidebuttons a.ls-nav-active, body .ls-roundedflat .ls-bottom-slidebuttons a:hover,.widget > h2:after, .widget > h4:after, .custom-widget > h4:after, .widget .widget-contact-content > h4:after, #footer-instagram p.clear a,.woocommerce #content input.button.alt:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce-page #content input.button.alt:hover, .woocommerce-page #respond input#submit.alt:hover, .woocommerce-page a.button.alt:hover, .woocommerce-page button.button.alt:hover, .woocommerce-page input.button.alt:hover, .cd-overlay-content span, .cd-nav-bg-fake, .nyssa-labeled h4,.top-bar .phone-mail li.text_field, .colored_bg,.nyssa_recent_posts .post-quote,.cbp-popup-singlePageInline .cbp-popup-close:hover:after,a#send-comment,.vc_btn3.vc_btn3-color-juicy-pink.vc_btn3-style-flat:focus, .vc_btn3.vc_btn3-color-juicy-pink.vc_btn3-style-flat:hover, .vc_btn3.vc_btn3-color-juicy-pink:focus, .vc_btn3.vc_btn3-color-juicy-pink:hover,.page-template-blog-masonry-grid-template .metas a:hover,.social-shares ul li a:hover i {
                background: #4beee9 !important;
                color: #fff !important;
            }

            .woocommerce #content input.button, .woocommerce #respond input#submit, .woocommerce a.button:not(.add_to_cart_button):not(.product_type_simple), .woocommerce button.button, .woocommerce input.button, .woocommerce-page #content input.button, .woocommerce-page #respond input#submit, .woocommerce-page a.button:not(.add_to_cart_button):not(.product_type_simple), .woocommerce-page button.button:not(.add_to_cart_button), .woocommerce-page input.button, .woocommerce #content div.product form.cart .button, .woocommerce div.product form.cart .button, .woocommerce-page #content div.product form.cart .button, .woocommerce-page div.product form.cart .button,.nav-container a.button.nyssa_minicart_cart_but, body.style9 a.button.nyssa_minicart_cart_but,.nav-container a.button.nyssa_minicart_checkout_but, body.style9 a.button.nyssa_minicart_checkout_but {
                color: #4beee9 !important;
                border: 2px solid #4beee9 !important;
            }

            .woocommerce #content input.button:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:not(.add_to_cart_button):not(.product_type_simple):hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce-page #content input.button:hover, .woocommerce-page #respond input#submit:hover, .woocommerce-page a.button:not(.add_to_cart_button):not(.product_type_simple):hover, .woocommerce-page button.button:hover, .woocommerce-page input.button:hover, .woocommerce #content div.product form.cart .button:hover, .woocommerce div.product form.cart .button:hover, .woocommerce-page #content div.product form.cart .button:hover, .woocommerce-page div.product form.cart .button:hover,.nav-container a.button.nyssa_minicart_cart_but:hover,body.style9 a.button.nyssa_minicart_cart_but:hover,.nav-container a.button.nyssa_minicart_checkout_but:hover, body.style9 a.button.nyssa_minicart_checkout_but:hover,body .button-dark:hover input {
                background: #4beee9 !important;
                border: 2px solid #4beee9 !important;
            }
            ...
            .testimonials.style1 .testimonial span a,.tabs.wc-tabs a:hover,.tabs.wc-tabs .active a {
                color: #4beee9 !important;
            }
            ...
            .widget.widget_pages li:not(li:first-child), .widget.widget_meta li:not(li:first-child), .widget.widget_recent_comments li:not(li:first-child), .widget.widget_recent_entries li:not(li:first-child), .widget.widget_nav_menu li:not(li:first-child), .widget.widget_archive li:not(li:first-child), .widget.widget_categories li:not(li:first-child), .wp-block-latest-posts li:not(li:first-child), .wp-block-latest-comments li:not(li:first-child), .product-categories li:not(li:first-child) {
                border-top: 1px solid #d6d5d9 !important;
            }

            .special_tabs.icontext.vertical .tab-selector,.special_tabs.text.vertical .tab-selector {
                border-right: 1px solid #d6d5d9 !important;
            }

            .special_tabs.vertical:not(.icon) .tab-selector .label,.minicart_total_checkout {
            ...
            #nav-below:not(.navigation_with_thumbnails) .nav-previous, #nav-below:not(.navigation_with_thumbnails) .nav-next, #nav-below:not(.navigation_with_thumbnails) .next-posts, #nav-below:not(.navigation_with_thumbnails) .prev-posts,#nav-below:not(.navigation_with_thumbnails) .nav-previous a, #nav-below:not(.navigation_with_thumbnails) .nav-next a,#nav-below:not(.navigation_with_thumbnails) .nav-next i, #nav-below:not(.navigation_with_thumbnails) .next-posts a, #nav-below:not(.navigation_with_thumbnails) .prev-posts a,#nav-below:not(.navigation_with_thumbnails) .nav-previous i, #nav-below:not(.navigation_with_thumbnails) .next-posts i,.single .blog-read-more, .home.blog .blog-read-more,.btn-contact-left input,.single #commentform .form-submit #submit, a#send-comment,.bt-contact a span input {
                color: #4beee9;
            }

            #nav-below:not(.navigation_with_thumbnails) .nav-previous:hover, #nav-below:not(.navigation_with_thumbnails) .nav-next:hover, #nav-below:not(.navigation_with_thumbnails) .next-posts:hover, #nav-below:not(.navigation_with_thumbnails) .prev-posts:hover,.single .blog-read-more:hover, .home.blog .blog-read-more:hover,.btn-contact-left input:hover,.single #commentform .form-submit #submit:hover, a#send-comment:hover {
                background: #4beee9;
            }

            #nav-below:not(.navigation_with_thumbnails) .nav-previous:hover a, #nav-below:not(.navigation_with_thumbnails) .nav-next:hover a, #nav-below:not(.navigation_with_thumbnails) .next-posts:hover a,#nav-below:not(.navigation_with_thumbnails) .nav-next:hover i, #nav-below:not(.navigation_with_thumbnails) .prev-posts:hover a,#nav-below:not(.navigation_with_thumbnails) .nav-previous:hover i, #nav-below:not(.navigation_with_thumbnails) .next-posts:hover i,.single .blog-read-more:hover, .home.blog .blog-read-more:hover,.btn-contact-left input:hover,.single #commentform .form-submit #submit:hover, a#send-comment:hover,.bt-contact a:hover span input {
                color: #fff !important;
            }

            #nav-below:not(.navigation_with_thumbnails) .nav-previous, #nav-below:not(.navigation_with_thumbnails) .nav-next, #nav-below:not(.navigation_with_thumbnails) .next-posts, #nav-below:not(.navigation_with_thumbnails) .prev-posts,.single .blog-read-more, .home.blog .blog-read-more,.btn-contact-left input,.single #commentform .form-submit #submit, a#send-comment,.bt-contact a:not(.button-dark) span input,.bt-contact a:hover span input {
                border: 2px solid #4beee9 !important;
            }

            /* New Borders Color */
            .widget_search input,.wpcf7 textarea,.wpcf7 input[type='text'], .wpcf7 input[type='email'],.wpcf7 input[type='tel'],.wpcf7 .select2-container--default .select2-selection--single,table td, table th,.vc_row .widget.des_recent_posts_widget .ult-item-wrap,#respond #comment,#comments #commentform input,.post-content,.des-pages a .postpagelinks, .navigation a.page,.woocommerce.widget_shopping_cart ul.product_list_widget,.related_posts_listing .related_post .related_post_bg {
            ...
            .nav-container a.button.nyssa_minicart_checkout_but:hover, .nav-container a.button.nyssa_minicart_cart_but:hover,body.style9 a.button.nyssa_minicart_checkout_but:hover, body.style9 a.button.nyssa_minicart_cart_but:hover {
                background-color: #4beee9 !important;
                color: #fff !important;
            }

            .nyssa-button-color-1d:hover, .nyssa-button-color-1d:active {
            ...
            .navbar-collapse ul.menu-depth-1 li:not(.nyssa_mega_hide_link) a, .dl-menuwrapper li:not(.nyssa_mega_hide_link) a, .gosubmenu, .nav-container .nyssa_minicart ul li, body.style9 .nyssa_minicart ul li {
                font-family: 'Inter', 'Arial', 'sans-serif', sans-serif;
                font-weight: normal;
                font-size: 15px;
                color: #3c3940;
            ...
            .dropdown-menu li.menu-item-has-children:not(.nyssa_mega_hide_link) > a:before,header .navbar-collapse ul.menu-depth-1 li:not(.nyssa_mega_hide_link) a,.dl-back {
                color: #3c3940;
            }

            /* changed the overs from lis to as to acommodate style8 */
            .navbar-collapse ul.menu-depth-1 li:not(.nyssa_mega_hide_link) > a:hover, .dl-menu li:not(.nyssa_mega_hide_link):hover > a, .dl-menu li:not(.nyssa_mega_hide_link):hover > a, .dl-menu li:not(.nyssa_mega_hide_link):hover > .gosubmenu, .dl-menu li.dl-back:hover, .navbar-nav:not(.cd-primary-nav) .dropdown-menu a:hover i, .dropdown-menu li.menu-item-has-children:not(.nyssa_mega_hide_link) > a:hover:before {
                color: #4beee9 !important;
            }
            ...
            .navbar-collapse .nyssa_mega_menu ul.menu-depth-2, .navbar-collapse .nyssa_mega_menu ul.menu-depth-2 ul {
                background-color: transparent !important;
            }
            ...
            .navbar-collapse ul.menu-depth-1 li:not(.nyssa_mega_hide_link):hover > a, .dl-menuwrapper li:not(.nyssa_mega_hide_link):hover > a, .dl-menuwrapper li:not(.nyssa_mega_hide_link):hover > a, .dl-menuwrapper li:not(.nyssa_mega_hide_link):hover > .gosubmenu, .dl-menuwrapper li.dl-back:hover, .navbar-nav .dropdown-menu a:hover i, .dropdown-menu li.menu-item-has-children:not(.nyssa_mega_hide_link):hover > a:before {
                color: #4beee9;
            }

            .menu-simple li:not(.nyssa_mega_menu) li.menu-item-depth-1:hover > a, .menu-simple li.menu-item-depth-2:hover > a, .menu-simple li.menu-item-depth-3:hover > a {
                background-color: rgba(255,255,255,1) !important;
            }

            .menu-square li:not(.nyssa_mega_menu) li.menu-item-depth-1:hover > a, .menu-square li.menu-item-depth-2:hover > a, .menu-square li.menu-item-depth-3:hover > a {
                background-color: rgba(255,255,255,1) !important;
            }
            ...
            .navbar-collapse > .header_style2_menu > ul > li > a:hover, .navbar-collapse > .header_style2_menu > ul > li.current-menu-ancestor > a, .navbar-collapse > .header_style2_menu > ul > li.current-menu-item > a, .navbar-collapse > .header_style2_menu > ul > li > a.selected,.navbar-collapse > .header_style2_menu > ul > li > a.hover_selected,.navbar-collapse ul.navbar-nav > li > a:hover, .navbar-collapse ul.navbar-nav > li.current-menu-ancestor > a, .navbar-collapse ul.navbar-nav > li.current-menu-item > a, .navbar-collapse ul.navbar-nav > li > a.selected,.navbar-collapse ul.navbar-nav > li > a.hover_selected,body.style9 .navbar-collapse ul.navbar-nav li.mobile-opened > a {
                color: #4beee9 !important;
            }
            ...
            body .vc_general.vc_btn3:hover,body .slider-button:hover,body .btn-contact-left input:hover, body .bt-contact a span input:hover,#nav-below:not(.navigation_with_thumbnails) .nav-previous:hover, #nav-below:not(.navigation_with_thumbnails) .nav-next:hover, #nav-below:not(.navigation_with_thumbnails) .next-posts:hover, #nav-below:not(.navigation_with_thumbnails) .prev-posts:hover,.single .blog-read-more:hover,.woocommerce #content input.button:hover, .woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce-page #content input.button:hover, .woocommerce-page #respond input#submit:hover, .woocommerce-page a.button:hover, .woocommerce-page button.button:hover, .woocommerce-page input.button:hover, .woocommerce #content div.product form.cart .button:hover, .woocommerce div.product form.cart .button:hover, .woocommerce-page #content div.product form.cart .button:hover, .woocommerce-page div.product form.cart .button:hover, header .nyssa-header-button a:hover,body .button-dark:hover input,.blog-read-more:hover {
            ...
            header.navbar-default.nyssa-underlining .navbar-nav > li:hover > a:before,.navbar-collapse ul.navbar-nav > li.current-menu-item > a:before,.navbar-collapse ul.navbar-nav > li.current-menu-ancestor > a:before,.navbar-collapse ul.navbar-nav > li > a.selected:before {
                background: #4beee9 !important;
            }

            .dropdown-menu li.menu-item-has-children:not(.nyssa_mega_hide_link) > a:hover:after,.dropdown-menu li.menu-item-has-children:not(.nyssa_mega_hide_link) > a:focus:after,.dropdown-menu li.menu-item-has-children:not(.nyssa_mega_hide_link) > a:active:after, .dropdown-menu li:hover > a:after {
                background: #4beee9 !important;
            }

            header.navbar-default.header_after_scroll .navbar-collapse ul.navbar-nav > li.current-menu-item > a:before,header.navbar-default.header_after_scroll .navbar-collapse ul.navbar-nav > li.current-menu-ancestor > a:before,header.navbar-default.header_after_scroll .navbar-collapse ul.navbar-nav > li > a.selected:before,header.navbar-default.header_after_scroll .navbar-nav > li:hover > a:before {
                background: #4beee9 !important;
            }
            ...
            header.style5 .nyssa_right_header_icons,header.style1 .nyssa_right_header_icons,header.style2 .nyssa_right_header_icons,header.style4 .nyssa_right_header_icons,header.style6 .nyssa_right_header_icons,header.style7 .nyssa_right_header_icons {
                padding-top: 32px;
                padding-bottom: 30px;
            }
            ...
            li.nyssa_mega_hide_link > a, li.nyssa_mega_hide_link > a:hover {
            ...
            .nav-container .nyssa_minicart li a, body.style9 .nyssa_minicart li a {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                font-size: 15px;
                color: #3c3940;
            ...
            .master_container a:not(.the_author):not(.the_cats):not(.the_tags):not(.blog-read-more):not(.button):not(.the_title):not(.vc_btn3):not(.special_tabs_linkage):not(.widget a):not(.blog-read-more):not(.ult_colorlink):not(.page-numbers):not(.tabs a):not(.the_title h2 a):not(.woocommerce-info a):not(.nav-next a):not(.nav-previous a):not(.widget a):not(.custom-widget a):not(.fn a), .page_content a:not(.the_author):not(.the_cats):not(.the_tags):not(.button):not(.the_title):not(.vc_btn3):not(.special_tabs_linkage):not(.widget a):not(.blog-read-more):not(.ult_colorlink):not(.page-numbers):not(.tabs a):not(.the_title h2 a):not(.woocommerce-info a):not(.nav-next a):not(.nav-previous a):not(.widget a):not(.custom-widget a):not(.fn a), header a, #big_footer a, .comment-body a, .logged-in-as a, #reply-title a {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                font-size: 15px;
                color: #4beee9
            ...
            .widget a:not(#primary_footer .widget a):not(.buttons a):not(.tagcloud a):not(.blog-read-more),.custom-widget a:not(#primary_footer .custom-widget a):not(.buttons a):not(.tagcloud a)not(.blog-read-more) {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                font-size: 15px;
                color: #003279 !important;
            ...
            .widget a:not(#primary_footer .widget a):not(.buttons a):not(.tagcloud a)not(.blog-read-more):hover,.custom-widget a:not(#primary_footer .custom-widget a):not(.buttons a):not(.tagcloud a)not(.blog-read-more):hover,.the_title h2 a:hover {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                font-size: 15px;
                color: #4beee9 !important;
            ...
            .widget .tagcloud a, .custom-widget .tagcloud a,.widget .tagcloud a:hover,.custom-widget .tagcloud a:hover {
                color: #fff !important;
            }

            .master_container a:not(.the_author):not(.metas-container a):not(.button):not(.vc_btn3):not(.page):not(.ult_colorlink):not(.special_tabs_linkage):not(.navcontentens-side a):not(.page):not(.the_title a):not(.page):not(.nav-previous a), .page_content a:not(.the_author):not(.metas-container a):not(.button):not(.vc_btn3):not(.special_tabs_linkage):not(.page):not(.ult_colorlink):not(.page):not(.the_title a):not(.page-numbers):not(.wp-block-group a) {
                line-height: 1.7em;
            }

            .master_container a:hover:not(.vc_btn3):not(.page):not(.button):not(.special_tabs_linkage):not(.widget li a):not(.page-numbers):not(.tabs a):not(.fn a), .page_content a:hover:not(.vc_btn3):not(.page):not(.button):not(.special_tabs_linkage):not(.widget li a):not(.page-numbers):not(.tabs a):not(.fn a), .comment-body a:hover, .logged-in-as a:hover, #reply-title a:hover {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                font-size: 15px;
                color: #383440
            ...
            .blog-default-bg-masonry .the_title h2 a,.des_recent_posts_widget.widget .title h4,.related_posts_listing .related_post .title,.home.blog .blog-default.wideblog .container .blog-default-bg-masonry .the_title h2 a,body.blog .blog-default-bg .blog-default-bg-masonry .the_title h2 a {
                font-family: 'Inter', 'Arial', 'sans-serif' !important;
                font-weight: 600 !important;
            ...
            #main .flip-box-wrap .flip_link a:hover,.woocommerce #content nav.woocommerce-pagination ul li a:focus, .woocommerce #content nav.woocommerce-pagination ul li a:hover, .woocommerce #content nav.woocommerce-pagination ul li span.current, .woocommerce nav.woocommerce-pagination ul li a:focus, .woocommerce nav.woocommerce-pagination ul li a:hover, .woocommerce nav.woocommerce-pagination ul li span.current, .woocommerce-page #content nav.woocommerce-pagination ul li a:focus, .woocommerce-page #content nav.woocommerce-pagination ul li a:hover, .woocommerce-page #content nav.woocommerce-pagination ul li span.current, .woocommerce-page nav.woocommerce-pagination ul li a:focus, .woocommerce-page nav.woocommerce-pagination ul li a:hover, .woocommerce-page nav.woocommerce-pagination ul li span.current {
                background-color: #4beee9 !important;
                color: #fff !important;
            }
            ...
            h2:not(.the_title h2):not(.woocommerce-loop-product__title):not(.cart_totals h2):not(.woocommerce-tabs h2):not(.related h2):not(h2.secondaryTitle):not(.uvc-main-heading h2):not(h2.ult-responsive),.woocommerce #content div.product .product_title, .woocommerce div.product .product_title, .woocommerce-page #content div.product .product_title, .woocommerce-page div.product .product_title {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: 700;
                font-size: 52px;
                color: #003279;
            ...
            .woocommerce h2.woocommerce-loop-product__title,.woocommerce #content div.product p.price, .woocommerce #content div.product span.price, .woocommerce div.product p.price, .woocommerce div.product span.price, .woocommerce-page #content div.product p.price, .woocommerce-page #content div.product span.price, .woocommerce-page div.product p.price, .woocommerce-page div.product span.price {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: 700;
                color: #003279;
            }
            ...
            .testimonials.style1 .testimonial span.t-author-style1,.testimonials.style1 .testimonial span a,.testimonials.style1 .testimonial span a:hover,.testimonials.style1 .testimonial span.t-author-style1,.testimonials.style1 .testimonial span.t-author-style1:hover {
                font-family: 'Inter', 'Arial', 'sans-serif' !important;
                font-weight: 600 !important;
            }
            ...
            header.header_after_scroll .navbar-collapse ul.menu-depth-1 li:not(.nyssa_mega_hide_link) a, header.header_after_scroll .dl-menuwrapper li:not(.nyssa_mega_hide_link) a, header.header_after_scroll .gosubmenu {
                color: #3c3940;
            }
            ...
            header.header_after_scroll .navbar-collapse ul.menu-depth-1 li:not(.nyssa_mega_hide_link):hover > a, header.header_after_scroll .dl-menuwrapper li:not(.nyssa_mega_hide_link):hover > a, header.header_after_scroll .dl-menuwrapper li:not(.nyssa_mega_hide_link):hover > a, header.header_after_scroll .dl-menuwrapper li:not(.nyssa_mega_hide_link):hover > header.header_after_scroll .gosubmenu, header.header_after_scroll .dl-menuwrapper li.dl-back:hover, header.header_after_scroll.navbar .nav-container .dropdown-menu li:hover {
                color: #4beee9 !important;
            }
            ...
            header.header_after_scroll .navbar-collapse .nyssa_mega_menu ul.menu-depth-2, header.header_after_scroll .navbar-collapse .nyssa_mega_menu ul.menu-depth-2 ul {
                background-color: transparent !important;
            }

            header li:not(.nyssa_mega_menu) ul.menu-depth-1 li:hover, header li.nyssa_mega_menu li.menu-item-depth-1 li:hover, header #dl-menu ul li:hover,header.header_after_scroll li:not(.nyssa_mega_menu) ul.menu-depth-1 li:hover, header.header_after_scroll li.nyssa_mega_menu li.menu-item-depth-1 li:hover, header.header_after_scroll #dl-menu ul li:hover {
                background-color: rgba(255,255,255,1) !important;
            }
            ...
            header.header_after_scroll.navbar-default .navbar-nav > li,header.headerclone.navbar-default .navbar-nav > li {
                padding-right: 20px;
                padding-left: 20px;
                margin-bottom: 0px;
            }
            ...
            header.header_not_fixed li:not(.nyssa_mega_menu) ul.menu-depth-1 li:hover, header.header_not_fixed li.nyssa_mega_menu li.menu-item-depth-1 li:hover, header.header_not_fixed #dl-menu ul li:hover {
                background-color: rgba(255,255,255,1) !important;
            }
            ...
            @media only screen and (max-width: 1024px) {
                #wpcf7-f831-o1 > form > div.nyssa-form-simple-wide > h4:nth-child(5){
                    padding-top:80%;
                }
                .present-container {
                ...
                body, p, .lovepost a, a.woocommerce-LoopProduct-link, .widget ul li a, .widget p, .widget span, .widget ul li, .the_content ul li, .the_content ol li, #recentcomments li, .custom-widget h4, .custom-widget h4 span, .widget.des_cubeportfolio_widget h4, .widget.des_recent_posts_widget h4, .custom-widget ul li a, .aio-icon-description, li, .smile_icon_list li .icon_description p, #recentcomments li span, .wpb-js-composer .vc_tta-color-grey.vc_tta-style-classic .vc_tta-panel .vc_tta-panel-title>a, .related_posts_listing .related_post .excerpt, .testimonials-slide-content .text-container span p, .testimonials-slide-content .text-container span, .testimonials-slide-content .text-container p,.vc_row .widget.des_recent_posts_widget .ult-item-wrap .excerpt p,.master_container a, .page_content a, .metas-comments p {
                    font-size: 15px !important;
                }

                .vc_row h1,
                #section-1504 > div > section > div.vc_row.wpb_row.vc_row-fluid.wide-ipad.vc_custom_1674495637682 > div > div > div > div:nth-child(4) > div:nth-child(2) > div > div > div.ult-content-box-container > div > h2{
                ...
                .blog-default-bg-masonry .the_title h2,.home.blog .blog-default.wideblog .container .blog-default-bg-masonry .the_title h2 a,body.blog .blog-default-bg .blog-default-bg-masonry .the_title h2 a {
                    font-size: 20px !important;
                }
            }
            ...
            .nyssa_breadcrumbs, .nyssa_breadcrumbs a, .nyssa_breadcrumbs span {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: 500;
                color: #e6e4ed;
                font-size: 14px;
            ...
            header.navbar .nav-container .nyssa_right_header_icons .icon,header .menu-controls .icon, header.style2 span.social_container i, header .menu-controls .icon, header .social_container i,header.style4 .nyssa_dynamic_shopping_bag .dripicons-cart,header.style4 .search_trigger .dripicons-search {
                color: #003279 !important;
            }
            ...
            header.style1 .search_trigger i, header.style1 .search_trigger_mobile i, header.style7 .search_trigger i, header.style7 .search_trigger_mobile i,header.style3 .search_trigger i, header.style3 .search_trigger_mobile i,header.style4 .search_trigger i, header.style4 .search_trigger_mobile i,header.style5 .search_trigger i, header.style4 .search_trigger_mobile i,.nyssa_little_shopping_bag .title i {
                color: #003279;
            }
            ...
            .header-style6-panel-open header.style6 .cd-nav-trigger .cd-icon, .header-style6-panel-open header.style6 .cd-nav-trigger .cd-icon::before, .header-style6-panel-open header.style6 .cd-nav-trigger .cd-icon:after {
                background-color: #ffffff !important;
            }

            header.navbar .nav-container .nyssa_right_header_icons .icon:hover,header .menu-controls .nyssa_right_header_icons .icon:hover, header.style2 span.social_container:hover i, header .social_container:hover i,header.style4 .nyssa_dynamic_shopping_bag .dripicons-cart:hover,header.style4 .search_trigger .dripicons-search:hover {
                color: #003279 !important;
            }

            header.header_after_scroll.navbar .nav-container .nyssa_right_header_icons .icon, header .menu-controls .nyssa_right_header_icons .icon, header.header_after_scroll .social_container i {
                color: #333 !important;
            }
            ...
            .nyssa-push-sidebar.nyssa-push-sidebar-right,.nyssa-push-sidebar-content .contact-form input[type='text'], .nyssa-push-sidebar-content .contact-form input[type='email'],.nyssa-push-sidebar-content .contact-widget-container textarea {
                background-color: #0f0624 !important;
            }

            .nyssa-push-sidebar .widget h2 > .widget_title_span, .nyssa-push-sidebar .wpb_content_element .wpb_accordion_header a, .nyssa-push-sidebar .custom-widget h4, .nyssa-push-sidebar .widget.des_cubeportfolio_widget h4, .nyssa-push-sidebar .widget.des_recent_posts_widget h4, .nyssa-push-sidebar .widget h4, .nyssa-push-sidebar h4, .nyssa-push-sidebar .widget h2 > .widget_title_span a.rsswidget, .nyssa-push-sidebar-content h4, .nyssa-push-sidebar-content .wp-block-group h2 {
                font-family: 'Inter', 'Arial', 'sans-serif' !important;
                font-weight: 700 !important;
                color: #ffffff !important;
            ...
            .nyssa-push-sidebar select,.nyssa-push-sidebar .widget_search input, .nyssa-push-sidebar .wp-block-search .wp-block-search__input {
                color: #0f0624 !important;
            }

            .nyssa-push-sidebar a:not(.vc_btn3),.nyssa-push-sidebar .select2-container--default .select2-results__option[data-selected=true],.nyssa-push-sidebar .select2-results__option,#nyssa-push-sidebar-content ul li {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                color: #feb4c3 !important;
                font-size: 15px;
            ...
            .nyssa-push-sidebar p,.nyssa-push-sidebar .widget ul li,.nyssa-push-sidebar .widget span,nyssa-push-sidebar-content .contact-form input,.nyssa-push-sidebar-content .contact-form input:not(.submit), .nyssa-push-sidebar-content .contact-widget-container textarea {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: normal;
                color: #b6b0c4 !important;
                font-size: 15px;
            ...
            .nyssa-push-sidebar-content input[placeholder]::placeholder, .nyssa-push-sidebar-content input[placeholder]::-webkit-input-placeholder {
                font-family: 'Inter', 'Arial', 'sans-serif' !important;
                font-weight: normal !important;
                color: #b6b0c4 !important;
                font-size: 15px !important;
            ...
            .nyssa-push-sidebar-content input[type],.nyssa-push-sidebar-content textarea {
            ...
            #nyssa-push-sidebar-content .widget h2 > .widget_title_span, #nyssa-push-sidebar-content .custom-widget h4, #nyssa-push-sidebar-content .custom-widget h4 span, #nyssa-push-sidebar-content .widget.des_cubeportfolio_widget h4, #nyssa-push-sidebar-content .widget.des_recent_posts_widget h4, #nyssa-push-sidebar-content .widget h2 > .widget_title_span a.rsswidget, .nyssa-push-sidebar h4,.nyssa-push-sidebar .widget h4, .nyssa-push-sidebar h4 {
                font-family: 'Inter', 'Arial', 'sans-serif';
                font-weight: 700;
                font-size: 17px;
            }
            ...
            #nyssa-push-sidebar-contentr h4,#nyssa-push-sidebar-content .sidebar-box,.nyssa-push-sidebar h4, .nyssa-push-sidebar .widget h4, .nyssa-push-sidebar h4 {
        ...
        <link rel='stylesheet' id='bsf-linearicons-css' href='https://preview.treethemes.com/nyssa/demo1/wp-content/uploads/sites/8/smile_fonts/linearicons/linearicons.css?ver=3.19.13' type='text/css' media='all'/>
        <link rel='stylesheet' id='ultimate-vc-addons-google-fonts-css' href='https://fonts.googleapis.com/css?family=Inter:regular,500' type='text/css' media='all'/>
        ...
        <link rel="alternate" type="application/json" href="https://preview.treethemes.com/nyssa/demo1/wp-json/wp/v2/pages/1504"/>
        ...
        <link rel="canonical" href="https://preview.treethemes.com/nyssa/demo1/pages/contacts-version-3/"/>
        <link rel='shortlink' href='https://preview.treethemes.com/nyssa/demo1/?p=1504'/>
        <link rel="alternate" type="application/json+oembed" href="https://preview.treethemes.com/nyssa/demo1/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fpreview.treethemes.com%2Fnyssa%2Fdemo1%2Fpages%2Fcontacts-version-3%2F"/>
        <link rel="alternate" type="text/xml+oembed" href="https://preview.treethemes.com/nyssa/demo1/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fpreview.treethemes.com%2Fnyssa%2Fdemo1%2Fpages%2Fcontacts-version-3%2F&#038;format=xml"/>
        <script type='text/javascript'>
    ...
    <body class="page-template page-template-page page-template-page-php page page-id-1504 page-child parent-pageid-24 theme-nyssa woocommerce-no-js wpb-js-composer js-comp-ver-6.10.0 vc_responsive">
        ...
        <input type="hidden" id="nyssa-theme-search" name="nyssa-theme-search" value="48d49eca9f"/>
        <input type="hidden" name="_wp_http_referer" value="/nyssa/demo1/pages/contacts-version-3/"/>
	 ...
	 header-full-width nyssa-underlining light" data-rel="light|light">
                <div class="nav-container ">
                    <div class="navbar-header">
                        <a class="navbar-brand nav-to" href="/" tabindex="-1">
                            <img class="logo_normal notalone" src="/img/import/Acceuil.png" alt="" title="Icone 1">
                            <img class="logo_retina" style="display:none; position: relative;" src="/img/import/Acceuil.png" alt="" title="Icone 1">
                            <img class="logo_normal logo_after_scroll notalone" src="/img/import/Acceuil.png" alt="" title="Icone 1">
                            <img class="logo_retina logo_after_scroll" style="display:none; position: relative;" src="/img/import/Acceuil.png" alt="" title="Icone 1">
                        </a>
                    </div>
                    <div id="dl-menu" class="dl-menuwrapper">
                        ...
                        <ul id="menu-primary-navigation" class="dl-menu">
                            ...
                            <li id="mobile-nav-menu-item-3965" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3965">
                    ...
                    <div class="navbar-collapse collapse">
                        <div class="menu_style5_bearer">
                            <ul id="menu-primary-navigation-1" class="nav navbar-nav navbar-right">
                                ...
                                <li id="nav-menu-item-3965" class="main-menu-item  menu-item-even menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children custom-3965">
                                    <a href="/contact.html" class="menu-link main-menu-link">Contact</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="master_container master_container_bgwhite">
                <section class="page_content" id="section-1504">
                    <div class="container">
                        <section class="wpb-content-wrapper">
                            <div class="vc_row wpb_row vc_row-fluid wide-ipad vc_custom_1674495637682">
                                <div class="box-paddingr wpb_animate_when_almost_visible wpb_fadeIn fadeIn wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div class="ult-spacer spacer-642dfbc73854f" data-id="642dfbc73854f" data-height="100" data-height-mobile="50" data-height-tab="" data-height-tab-portrait="80" data-height-mobile-landscape="50" style="clear:both;display:block;"></div>
                                            <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                                    <div class="vc_column-inner">
                                                        <div class="wpb_wrapper">
                                                            <p style="text-align: left" class="vc_custom_heading heading_border">Vous faites</p>
                                                            <h1 style="text-align: left; font-size:44px;" class="vc_custom_heading no-letter-spacing">Un parrainage</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="ult-spacer spacer-642dd4f410099" data-id="642dd4f410099" data-height="50" data-height-mobile="25" data-height-tab="" data-height-tab-portrait="25" data-height-mobile-landscape="25" style="clear:both;display:block;"></div>
                                            <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                                <div class="wpb_column vc_column_container vc_col-sm-6">
                                                    <div class="vc_column-inner">
                                                        <div class="wpb_wrapper">
                                                            <div class="wpcf7 no-js" id="wpcf7-f831-o1" lang="en-US" dir="ltr">
                                                                <div class="screen-reader-response">
                                                                    <p role="status" aria-live="polite" aria-atomic="true"></p>
                                                                    <ul></ul>
                                                                </div>
                                                                <form action="{{ route('font.parraines.store') }}" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                                                                    @csrf
                                                                    <!-- @method("PUT") -->
                                                                    <div class="nyssa-form-simple-wide">
                                                                        <h4 style="text-align: left" class="vc_custom_heading no-letter-spacing">Je deviens parrain.</h4>
                                                                        <div class="f-name">
                                                                            <p>
                                                                                <span class="wpcf7-form-control-wrap" data-name="your-name">
                                                                                    <input class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Nom et prénom" value="" type="text" name="nomprep"/>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="f-email">
                                                                            <p>
                                                                                <span class="wpcf7-form-control-wrap" data-name="your-email">
                                                                                    <input class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="L'email" value="" type="email" name="eamilp"/>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="f-email">
                                                                            <p>
                                                                                <span class="wpcf7-form-control-wrap" data-name="your-email">
                                                                                    <input class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Téléphone" value="" type="text" name="telephonp"/>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                        <h4 style="text-align: left; padding-top: 56%;" class="vc_custom_heading no-letter-spacing">La personne que je parraine.</h4>
                                                                        <div class="f-name">
                                                                            <p>
                                                                                <span class="wpcf7-form-control-wrap" data-name="your-name">
                                                                                    <input class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Nom et prénom" value="" type="text" name="nomprepp"/>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="f-email">
                                                                            <p>
                                                                                <span class="wpcf7-form-control-wrap" data-name="your-email">
                                                                                    <input class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="L'email" value="" type="email" name="emailpp"/>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="f-email">
                                                                            <p>
                                                                                <span class="wpcf7-form-control-wrap" data-name="your-email">
                                                                                    <input class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Téléphone" value="" type="text" name="telephonpp"/>
                                                                                </span>
                                                                            </p>
                                                                        </div>
                                                                        <div class="bt-contact">
                                                                            <p style="text-align: center;">
                                                                                <a href="">
                                                                                    <span>
                                                                                        <input class="wpcf7-form-control has-spinner wpcf7-submit" type="submit" value="Envoyez"/>
                                                                                    </span>
                                                                                </a>
                                                                            </p>
                                                                        </div>
                                                ...
                                                <div class="wpb_column vc_column_container vc_col-sm-6">
                                                    <div class="vc_column-inner">
                                                        <div class="wpb_wrapper">
                                                            <div class="ult-spacer spacer-642dd4f410bbe" data-id="642dd4f410bbe" data-height="" data-height-mobile="40" data-height-tab="" data-height-tab-portrait="" data-height-mobile-landscape="40" style="clear:both;display:block;"></div>
                                                            <div class="ult-content-box-container ">
                                                                <div class="ult-content-box" style="box-shadow: px px px px none;margin-top:25%;margin-right:5px;margin-bottom:0px;margin-left: 10%;-webkit-transition: all 700ms ease;-moz-transition: all 700ms ease;-ms-transition: all 700ms ease;-o-transition: all 700ms ease;transition: all 700ms ease;" data-hover_box_shadow="none" data-responsive_margins="margin:0px;" data-normal_margins="margin-top:25%;margin-right:5px;margin-bottom:0px;margin-left: 10%;">
                                                                    <h3 style="text-align: left" class="vc_custom_heading no-letter-spacing">LE PARRAINAGE DU CHALLENGER.</h3>
                                                                    <h4 style="text-align: left;font-size: 18px;" class="vc_custom_heading no-letter-spacing">Aidez vos proches dans leur projet immobilier<span class="block"><br/></span> en leur faisant découvrir challenge-toit.</h4>
                                                                    <p style="text-align: left;text-indent: -12px;" class="vc_custom_heading no-letter-spacing">• Parrain : gagnez un bon d'achat ou un week-end pour deux,<span class="block"><br/></span> tous frais payés. <br>Si vous êtes un de nos challengers bénéficiez d’un mois de cotisation offert.</p>
                                                                    <p style="text-align: left;text-indent: -12px;" class="vc_custom_heading no-letter-spacing">• Filleul : obtenez une soustraction d’un mois de cotisation<span class="block"><br/></span> sur votre challenge.</p>
                                                                    ...
                                                                    <div class="uavc-list-icon uavc-list-icon-wrapper ult-adjust-bottom-margin   ">
                                                                        <!-- <ul class="uavc-list">
                                                                            <li>
                                                                                <div class="uavc-list-content" id="list-icon-wrap-1804">
                                                                                    <div class="uavc-list-icon  " data-animation="" data-animation-delay="03" style="margin-right:20px;">
                                                                                        <div class="ult-just-icon-wrapper  ">
                                                                                            <div class="align-icon" style="text-align:center;">
                                                                                                <div class="aio-icon circle " style="color:#ffffff;background:#4beee9;font-size:20px;display:inline-block;">
                                                                                                    <i class="linearicons-home2"></i>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <span data-ultimate-target='#list-icon-wrap-1804 .uavc-list-desc' data-responsive-json-new='{"font-size":"","line-height":""}' class="uavc-list-desc ult-responsive" style="font-family:&#039;Inter&#039;;font-weight:500;">
                                                                                        30 South Park Avenue, CA 94108<br/>San Francisco USA
                                                                                    </span>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="uavc-list-content" id="list-icon-wrap-4211">
                                                                                    <div class="uavc-list-icon  " data-animation="" data-animation-delay="03" style="margin-right:20px;">
                                                                                        <div class="ult-just-icon-wrapper  ">
                                                                                            <div class="align-icon" style="text-align:center;">
                                                                                                <div class="aio-icon circle " style="color:#ffffff;background:#4beee9;font-size:20px;display:inline-block;">
                                                                                    ...
                                                                                    <span data-ultimate-target='#list-icon-wrap-4211 .uavc-list-desc' data-responsive-json-new='{"font-size":"","line-height":""}' class="uavc-list-desc ult-responsive" style="font-family:&#039;Inter&#039;;font-weight:500;">geral@example.com</span>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div class="uavc-list-content" id="list-icon-wrap-2690">
                                                                                    <div class="uavc-list-icon  " data-animation="" data-animation-delay="03" style="margin-right:20px;">
                                                                                        <div class="ult-just-icon-wrapper  ">
                                                                                            <div class="align-icon" style="text-align:center;">
                                                                                                <div class="aio-icon circle " style="color:#ffffff;background:#4beee9;font-size:20px;display:inline-block;">
                                                                                    ...
                                                                                    <span data-ultimate-target='#list-icon-wrap-2690 .uavc-list-desc' data-responsive-json-new='{"font-size":"","line-height":""}' class="uavc-list-desc ult-responsive" style="font-family:&#039;Inter&#039;;font-weight:500;">(123) 456-7890</span>
                                                                                </div>
                                                                            </li>
                                                                        </ul> -->
                                                                    </div>
                                                                    ...
                                                                    <div class="ult-spacer spacer-642dd4f41140e" data-id="642dd4f41140e" data-height="0" data-height-mobile="70" data-height-tab="" data-height-tab-portrait="" data-height-mobile-landscape="70" style="clear:both;display:block;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <!-- Row Backgrounds -->
                            <!-- <div class="upb_bg_img" data-ultimate-bg="url(/img/import/FORME.svg)" data-image-id="id^491|url^/img/import/FORME.svg|caption^null|alt^null|title^bgnyssahome2|description^null" data-ultimate-bg-style="vcpb-default" data-bg-img-repeat="no-repeat" data-bg-img-size="cover" data-bg-img-position="" data-parallx_sense="30" data-bg-override="ex-full" data-bg_img_attach="scroll" data-upb-overlay-color="" data-upb-bg-animation="" data-fadeout="" data-bg-animation="left-animation" data-bg-animation-type="h" data-animation-repeat="repeat" data-fadeout-percentage="30" data-parallax-content="" data-parallax-content-sense="30" data-row-effect-mobile-disable="true" data-img-parallax-mobile-disable="true" data-rtl="false" data-custom-vc-row="" data-vc="6.10.0" data-is_old_vc="" data-theme-support="" data-overlay="false" data-overlay-color="" data-overlay-pattern="" data-overlay-pattern-opacity="" data-overlay-pattern-size=""></div> -->
        ...
        <script type='text/javascript' id='contact-form-7-js-extra'>
            ...
            var wpcf7 = {
                "api": {
                    "root": "https:\/\/preview.treethemes.com\/nyssa\/demo1\/wp-json\/",
