...
<head>
    ...
    <!--<link rel='stylesheet' href='https://toitsurmesure.com/js/main.css' type='text/css' />-->
    ...
    <style type="text/css" data-type="vc_custom-css">
        .admin-bar .ult-sticky.ult-stick-full-width {
            top: 110px !important;
        }
    ...
    <style type="text/css" data-type="vc_shortcodes-custom-css">
        ...
        .vc_custom_1675698850028 {
            background-image: url(https://preview.treethemes.com/nyssa/demo1-clean/wp-content/uploads/sites/2/2022/12/marek-levak-NNGlG-RNBiI-unsplash-scaled.jpg?id=1967) !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        }

        .vc_custom_1671640053393 {
            margin-bottom: 40px !important;
        }

        .vc_custom_1675697974058 {
...
<body
    ...
    <div id="main">
	 ...
	 header-full-width nyssa-underlining dark" data-rel="dark|light">
            ...
            <section class="page_content" id="section-1494">
                <div class="container">
                    <section class="wpb-content-wrapper">
                        ...
                        <!-- Row Backgrounds -->
                        <!--<div class="upb_content_iframe" data-controls="" data-viewport-video="false" data-ultimate-video="https://www.youtube.com/watch?v=KWYu1i-QUvI" data-bg-override="ex-full" data-start-time="" data-stop-time="" data-ultimate-video-muted="muted" data-ultimate-video-loop="loop"-->
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        ...
                                        <section class='special_tabs icontext vertical'>
                                                        ...
                                                        <div class="vc_column-inner vc_custom_1474056192226">
                                                            <div class="wpb_wrapper">
                                                                <div class="ult-spacer spacer-64130a705518d"
                                                                    data-id="64130a705518d" data-height=""
                                                                    data-height-mobile="40" data-height-tab=""
                                                                ...
                                                                <div
                                                                    ...
                                                                    <figure class="wpb_wrapper vc_figure">
                                                                        <div
                                                                            class="vc_single_image-wrapper   vc_box_border_grey">
                                                                            <img width="1662" height="1280"
                                                                                src="/img/import/I-NON SALARIE.jpg"
                                                                                class="vc_single_image-img attachment-full"
                                                                                alt="" decoding="async" loading="lazy"
                                                                                title="app-design" />
                                                                        </div>
                                                                ...
                                                                <h5 style="text-align: left" class="vc_custom_heading">
                                                                    Non salarié et Diaspora</h5>
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        <p>S’inscrire sur notre plateforme
                                                                            <br>
                                                                            <br><u>Documents à fournir</u>
                                                                            <br>• 2 photos d’identités
                                                                            <br>• CNI ou pièces d’identités en cours de
                                            ...
                                            <!--<div class='label 4'>-->
                                            <!--    <div class='nyssa_icon_special_tabs'>-->
                                            <!--        <img src="/img/import/I-HAUT-4.png" width="40px" height="40px"-->
                                            <!--            alt="icone" style="margin-top: 2px;" />-->
                                            <!--    </div>-->
                                            <!--    <div class='title'>-->
                                            <!--        <a class='special_tabs_linkage'-->
                                            <!--            style="text-transform:initial;">Challenges en vidéo</a>-->
                                            <!--    </div>-->
                                            <!--    <div class='divider-vertical-tabs'></div>-->
                                            <!--</div>-->
                                            ...
                                            <!--            <div class="vc_column-inner vc_custom_1474056192226">-->
                                            <!--                <div class="wpb_wrapper">-->
                                            <!--                    <h4 style="color: #4beee9;text-align: left"-->
                                            <!--                        class="vc_custom_heading">Video / Motion</h4>-->
                                            <!--                    <div class="wpb_text_column wpb_content_element ">-->
                                            <!--                        <div class="wpb_wrapper">-->
                                            <!--                            <p>-->
                                                                            <!-- Completely -->
                                        ...
                                        <div class="ult-spacer spacer-64130a705917f" data-id="64130a705917f"
                                            ...
                                            <!--		<div class="ult-content-box"-->
                                            <!--			style="background-color: rgb(255, 255, 255);box-shadow: rgba(28, 12, 61, 0.06) 10px 10px 30px 10px;padding: 60px;margin: 0px 30px;transition: all 700ms ease 0s;border-color: transparent;"-->
                                            <!--			data-hover_box_shadow=" 10px 10px 30px 10px rgba(28,12,61,0.06) " data-responsive_margins="margin:0px;"-->
                                            <!--			data-normal_margins="margin-top:0px;margin-right:30px;margin-bottom:0px;margin-left:30px;"-->
                                            <!--			data-bg="#ffffff">-->
                                            <!--			<p style="text-align: left" class="vc_custom_heading heading_border vc_custom_1675770526092">Passez à la-->
                                            <!--				simulation</p>-->
                                            <!--			<h2 style="text-align: left" class="vc_custom_heading">Découvrez votre challenge personnalisé !</h2>-->
                                            <!--			<div class="vc_empty_space" style="height: 40px">-->
                                            <!--                   <span class="vc_empty_space_inner"></span>-->
                                            <!--               </div>-->
                                            <!--			<div class="vc_btn3-container vc_btn3-left">-->
                                            <!--			    <button id="openModal"-->
                                            <!--                       onmouseleave="this.style.borderColor='#4beee9'; this.style.backgroundColor='transparent'; this.style.color='#4beee9'" onmouseenter="this.style.borderColor='#4beee9'; this.style.backgroundColor='#4beee9'; this.style.color='#ffffff';" style="border-color:#4beee9; color:#4beee9;"-->
                                            <!--                       class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-round vc_btn3-style-outline-custom">Essayez !</button>-->
                                            <!--               </div>-->
                        ...
                        <!-- <div class="vc_row wpb_row vc_row-fluid">
                            <div
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper" style="margin: 0px 7%;">
                                        
                                        <div class="ult-spacer spacer-6426a12956377" data-id="6426a12956377" data-height="50"
                            ...
                            <div
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper" style="margin: 4% 2% 0px 10%;padding: 0% 14% 0% 14%;">
                                        ...
                                        <!--        <div class="vc_column-inner">-->
                                        <!--            <div class="wpb_wrapper">-->
                                        <!--                <h1 style="text-align: left" class="vc_custom_heading no-letter-spacing">Get in touch</h1>-->
                                        <!--            </div>-->
                                        <!--        </div>-->
                                        <!--    </div>-->
                                        <!--</div>-->
                                        <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                            ...
                                            <!--                    <h4 style="text-align: left; font-size:15px;" class="vc_custom_heading no-letter-spacing">-->
                                            <!--                        Crée ton challenge personnalisé-->
                                            <!--                        <a href="#zone-simulateur"><button-->
                                            <!--                                style="background-color:#4beee9; color:#003279; margin-top:12px;"-->
                                                    ...
                                                    <div class="wpb_column vc_column_container vc_col-sm-12" >
                                                        <div class="vc_column-inner">
                                                            <div class="wpb_wrapper">
                                                                    ...
                                                                    <div id="Info-box-wrap-4564"
                                                                        ...
                                                                        <div class="aio-ibd-block">
                                                                            ...
                                                                            <div class="aio-icon-description ult-responsive"
                                                                                ...
                                                                                constituer ton fonds de garantie sur 6
                                                                                mois).</div>
                                                                            <!-- description -->
                                                                        </div>
                                                                        <!-- aio-ibd-block -->
                                                                ...
                                                                <!--                            data-ultimate-target='#Info-box-wrap-4564 .aio-icon-title'-->
                                                                <!--                            data-responsive-json-new='{"font-size":"desktop:18px;","line-height":""}'-->
                                                                <!--                            style="font-family:&#039;Inter&#039;;font-weight:700;color:#4beee9;width: 85px;">-->
                                                                <!--                            <u>NB:</u></h3>-->
                                                                <!--                    </div>-->
                                                                <!--                </div>-->
                                                                <!--            </div>-->
                                                                ...
                                                                <!--                data-responsive-json-new='{"font-size":"","line-height":""}'-->
                                                                <!--                style="font-family:&#039;Inter&#039;;">-->
                                                                <!--                • Pour les non-salariés et les personnes-->
                                                                <!--                vivants à l’extérieur, les livraisons se-->
                                                                <!--                font après paiement intégral du montant-->
                                                                <!--                de la maison.-->
                                                                <!--                <br>• Pour les groupements (Mutuelles,-->
                                            ...
                                            <div id="treethemes-recent-posts-shortcode-2"
                                                ...
                                                <div class="recent-posts-post image "
                                                    ...
                                                    <div class="recentpostsvc">
                                                        ...
                                                        <!--    </a>-->
                                                        <!--</div>-->
                                                        <h4 style="font-size: 16px !important;">C’est toi qui décides</h4>
                                                        <h5 style="font-size:14px; font-weight:500;">
                                                            De l'emplacement au mode de paiement tout dépend de toi
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-row">
                        <div>
                            <label for="engage">Engagement annuel !</label>
                            <select id="engage" name="engage" style="">
                                <option selected value="1500000">1.500.000 Fcfa</option>
                    ...
                    <table style="width: 97%;">
                        <tr>
                            <!--<th colspan="2">Engagement annuel<br><h4 style="font-size: 10px;">(1,5 million chaque année)</h4></th>-->
                            <th colspan="2">Cotisation mensuelle</th>
                        </tr>
                        <tr>
                            <td colspan="2" id="cotmen"></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <!--<script type='text/javascript' src="https://toitsurmesure.com/js/index.min.js"></script>-->
        <!--<script type='text/javascript' src="https://toitsurmesure.com/js/JSModal.js"></script>-->
        ...
        <style id='nyssa-custom-style-inline-css' type='text/css'>
            ...
            .vc_custom_1675698850028 {
                background-image: url("/img/import/I-FONCTIONNEMENT.jpg") !important;
                background-position: center !important;
                background-repeat: no-repeat !important;
                background-size: cover !important;
            }
